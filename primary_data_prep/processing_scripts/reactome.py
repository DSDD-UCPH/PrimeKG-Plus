...
# df_ncbi2reactome = pd.read_csv('../data/reactome/20251124-NCBI2Reactome.txt',sep='\t', names=['ncbi_id', 'reactome_id', 'url','reactome_name','evidence_code', 'species'])
...
# df_ncbi2reactome.to_csv('../data/reactome/20251124-reactome_ncbi.csv', index=False)

df_terms = pd.read_csv('../data/reactome/ReactomePathways.txt', sep='\t', names=['reactome_id', 'reactome_name', 'species'])
# df_terms = pd.read_csv('../data/reactome/20251124-ReactomePathways.txt', sep='\t', names=['reactome_id', 'reactome_name', 'species'])
...
# df_terms.to_csv('../data/reactome/20251124-reactome_terms.csv', index=False)
...
# df_rels = pd.read_csv('../data/reactome/20251124-ReactomePathwaysRelation.txt', sep='\t', names=['reactome_id_1', 'reactome_id_2'])
...
# df_rels.to_csv('../data/reactome/20251124-reactome_relations.csv', index=False)