...
# with open('../data/ctd/20251124-CTD_exposure_events.csv', 'r') as f:
    lines = f.readlines()
...
# pd.read_csv('../data/ctd/exposure_data.csv', index_col=False).to_csv('../data/ctd/20251124_exposure_data.csv', index=False)